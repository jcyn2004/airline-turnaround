...
|---------------------|------------|
| **To upstream**     | `gate_id`, `deplaning_equipment_type`, `deplaning_equipment_id`, `deplaning_equipment_readiness_time`, `deplaning_equipment_score`, `jetbridge_connection_status`, `stairtruck_connection_status` |
| **From upstream**   | `flight_number`, `aircraft_type`, `gate_id`, `flight_status`, `deplaning_equipment_type`, `acu_connection_status`, `gpu_connection_status`, `wheels_chocks_installation_status` |
| **To downstream**   | `flight_number`, `aircraft_type`, `gate_id`, `flight_status`, `deplaning_equipment_type`, `acu_connection_status`, `gpu_connection_status`, `wheels_chocks_installation_status` |
| **From downstream** | `flight_number`, `aircraft_type`, `gate_id`, `deplaning_equipment_type`, `deplaning_equipment_id`, `deplaning_equipment_readiness_time`, `deplaning_equipment_score`, `jetbridge_connection_status`, `stairtruck_connection_status` |
