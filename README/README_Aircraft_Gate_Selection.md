...
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **To upstream**     | `gate_id`, `deplaning_equipment_type`, `deplaning_equipment_id`, `deplaning_equipment_readiness_time`, `deplaning_equipment_score`                      |
| **From upstream**   | `flight_number`, `aircraft_type`                                                                                                                        |
| **To downstream**   | `flight_number`, `aircraft_type`                                                                                                                        |
| **From downstream** | `flight_number`, `aircraft_type`, `gate_id`, `deplaning_equipment_type`, `deplaning_equipment_id`, `deplaning_equipment_readiness_time`, `deplaning_equipment_score` |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|

> Note: This network is an early-stage upstream-producer: `to_upstream` and `from_downstream` carry the produced gate/deplaning-equipment fields, while `from_upstream` and `to_downstream` propagate only the flight identity (`flight_number`, `aircraft_type`). `deplaning_equipment_readiness_time` is returned by `deplaning_path_selector` and shown in the summary.
