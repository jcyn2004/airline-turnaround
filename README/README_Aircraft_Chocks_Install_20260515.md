...
| **To downstream** | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `wheels_chocks_installation_status` |
| **From downstream** | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `wheels_chocks_installation_status` |
