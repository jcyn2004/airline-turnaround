...
|---------------------|---------------------------------------------------------------------------------------------|
| **To upstream**     | `aircraft_type`, `gate_id`, `gpu_readiness_status`, `flight_number`, `flight_status`        |
| **To downstream**   | `aircraft_type`, `flight_number`, `gate_id`, `gpu_readiness_status`                         |
| **From upstream**   | `aircraft_type`, `flight_number`, `flight_status`, `gate_id`, `gpu_readiness_status`        |
| **From downstream** | `aircraft_type`, `flight_number`, `gate_id`, `gpu_readiness_status`                         |

`flight_number` is carried in all four directions; `flight_status` is exchanged with upstream only (both `to_upstream` and `from_upstream`).
