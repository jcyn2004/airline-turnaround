...
|---------------------|------------|
| **To upstream**     | `wheels_chocks_readiness_status`, `acu_readiness_status`, `gpu_readiness_status`, `baggage_unload_status`, `inspection_maintenance_status`, `fueling_status` |
