...
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **To upstream**     | `crew_exit_status`, `flight_status`, `door_opening_status`, `jetbridge_connection_status`                                                                                                          |
| **To downstream**   | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `jetbridge_connection_status`, `stairtruck_connection_status`, `deplaning_equipment_type`, `door_opening_status`, `crew_exit_status` |
| **From upstream**   | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `jetbridge_connection_status`, `stairtruck_connection_status`, `deplaning_equipment_type`, `door_opening_status`, `crew_exit_status` |
| **From downstream** | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `jetbridge_connection_status`, `stairtruck_connection_status`, `deplaning_equipment_type`, `door_opening_status`, `crew_exit_status` |
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

> Note: `to_upstream` carries only 4 fields (`crew_exit_status`, `flight_status`, `door_opening_status`, `jetbridge_connection_status`), while `to_downstream` carries the full 9-field context set. `stairtruck_connection_status` and `deplaning_equipment_type` propagate downstream but not upstream.
...
> Note: This is the same field list that appears commented-out in other networks (e.g. `aircraft_cabin_cleaning`, `aircraft_catering_loading`). This network is where it is active.
