...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| **To upstream**     | `clearance_type`, `flight_status`, `flight_number`, `aircraft_type`, `aircraft_direction`, `assigned_runway_id`, `assigned_runway_length` |
| **To downstream**   | same 7 fields                                                                                                                             |
| **From upstream**   | same 7 fields                                                                                                                             |
| **From downstream** | same 7 fields                                                                                                                             |
