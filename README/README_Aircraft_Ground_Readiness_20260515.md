...
| **From upstream**   | `aircraft_type`, `flight_number`, `gate_id`, `gpu_readiness_status`, `acu_readiness_status`, `wheels_chocks_readiness_status`     |
| **From downstream** | `aircraft_type`, `gate_id`, `gpu_readiness_status`, `acu_readiness_status`, `wheels_chocks_readiness_status`                     |
