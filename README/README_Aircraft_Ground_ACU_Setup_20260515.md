...
|---------------------|----------------------------------------------------------------------|
| **To upstream**     | `aircraft_type`, `flight_number`, `gate_id`, `acu_readiness_status`  |
| **To downstream**   | `aircraft_type`, `flight_number`, `gate_id`, `acu_readiness_status`  |
| **From upstream**   | `aircraft_type`, `flight_number`, `gate_id`, `acu_readiness_status`  |
