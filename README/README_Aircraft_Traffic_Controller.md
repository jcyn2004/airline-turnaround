...
| **To downstream**   | `flight_number`, `aircraft_type`, `aircraft_direction`                                                                  |
| **To upstream**     | `clearance_type`, `assigned_runway_id`, `assigned_runway_length`, `flight_status`                                       |
| **From downstream** | `flight_number`, `aircraft_type`, `clearance_type`, `assigned_runway_id`, `assigned_runway_length`, `flight_status`     |
