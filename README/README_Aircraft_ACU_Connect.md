...
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
| **To downstream**   | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `engines_stop_status`, `wheels_chocks_installation_status`, `acu_connection_status` |
| **From downstream** | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `engines_stop_status`, `wheels_chocks_installation_status`, `acu_connection_status` |
| **To upstream**     | `acu_connection_status`                                                                                                                           |
| **From upstream**   | `flight_number`, `aircraft_type`, `flight_status`, `gate_id`, `engines_stop_status`, `wheels_chocks_installation_status`, `acu_connection_status` |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|
...
- The HOCON definition of `TrackerAPI` contains a duplicate `acu_connection_status` property. This is harmless but can be deduplicated during schema maintenance.
- The HOCON uses the field name `wheels_chucks_installation_status` (typo: "chucks") in the agent instructions, while the Python code and schema use `wheels_chocks_installation_status`. The coded tools use the correct spelling; the typo exists only in the LLM instruction text.
