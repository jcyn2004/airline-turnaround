...
| Direction         | Fields                                                                                                                                                                                                                      |
|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `to_upstream`     | `cabin_cleaning_status`, `lavatory_service_status`, `catering_loading_status`                                                                |
| `from_upstream`   | `flight_number`, `aircraft_type`, `gate_id`, `flight_status`, `passenger_disembarkation_status`, `crew_exit_status`, `baggage_unload_status` |
| `from_downstream` | `flight_number`, `aircraft_type`, `gate_id`, `flight_status`, `cabin_cleaning_status`, `lavatory_service_status`, `catering_loading_status`  |
| `to_downstream`   | `flight_number`, `aircraft_type`, `gate_id`, `flight_status`, `passenger_disembarkation_status`, `crew_exit_status`, `baggage_unload_status` |
