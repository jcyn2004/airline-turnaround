...
class cleaning_tracker(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        user_request: str = args.get("app_user_requestname", None)
        print("\n")
        print("\n")
        print("user_request in args: ",user_request)
        print("\n")
        print("\n")
        if not user_request:
            print("No user request provided. Trying to get it from sly_data")
            user_request = sly_data.get("user_request")
            print("\n")
            print("\n")
            print("user_request in sly_data: ",user_request)
            print("\n")
            print("\n")   
        if sly_data.get("user_request", None) is None:
            sly_data["user_request"] = user_request
        ...
        print("\n")
        if not user_request_compliant:
            print("No user request compliant provided. Trying to get it from sly_data")
            user_request_compliant = sly_data.get("user_request_compliant")
            print("\n")
            print("\n")
            print("user_request_compliant in sly_data: ",user_request_compliant)
