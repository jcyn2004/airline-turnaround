...
class inspection_maintenance_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### INSPECTION MAINTENANCE OPERATOR #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### INSPECTION MAINTENANCE OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### INSPECTION MAINTENANCE OPERATOR - PASSENGER DISEMBARKATION STATUS - CREW EXIT STATUS - BAGGAGE UNLOAD STATUS #################### ")
        print("\n")
        print("\n")
        ...
        if (((passenger_disembarkation_status == 'completed') | (passenger_disembarkation_status == 'done')) & ((crew_exit_status == 'completed') | (crew_exit_status == 'exited')) & ((baggage_unload_status == 'completed') | (baggage_unload_status == 'unloaded'))):
            ...
            message = f"Flight {flight_number} with airplane type {aircraft_type} {flight_status} at gate {gate_id} has inspection and maintenance {inspection_maintenance_status}. Its inspection and maintenance status is {inspection_maintenance_status}."
            print(message)
            print("\n")
            print("\n")
            print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
            ...
            sly_data["inspection_maintenance_status"] = inspection_maintenance_status

        # return message
        return inspection_maintenance_status
