...
class wheels_chocks_operator(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### WHEELS CHOCKS OPERATOR #################### ")
        print("\n")
        print("\n")

        print("\n")
        print("\n")
        print(" #################### WHEELS CHOCKS OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        if (('on' in flight_status) & ('blocks' in flight_status)): 
            ...
            print("\n")
            print("\n")
            print(" #################### WHEELS CHOCKS OPERATOR - FLIGHT STATUS UPDATE - WHEELS CHOCKS INSTALLED #################### ")
            print("\n")
            print("\n")
            print('wheels_chocks_installation_status is: ', wheels_chocks_installation_status)
            print("\n")
            print("\n")
            message = f"Flight {flight_number} with airplane type {aircraft_type} {flight_status} at gate {gate_id} has wheels chocks installed. Its wheels chocks installation status is {wheels_chocks_installation_status}."
            print(message)
            print("\n")
            print("\n")
            print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
