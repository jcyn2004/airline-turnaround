...
class crew_debrief_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        crew_debrief_status = 'pending'

        print("\n")
        print("\n")
        print(" #################### CREW DEBRIEF OPERATOR #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### CREW DEBRIEF OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### CREW DEBRIEF OPERATOR - JERTBRIDGE CONNECT STATUS UPDATE - DOOR OPENING STATUS #################### ")
        print("\n")
        print("\n")
        ...
        if jetbridge_connection_status == 'connected' and door_opening_status == 'open':
            ...
            sly_data["crew_debrief_status"] = crew_debrief_status

        # return message
        return crew_debrief_status
...
class trackerAPI(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        # Check and update crew_debrief_status
        crew_debrief_status: str = args.get("crew_debrief_status", None)
        if not crew_debrief_status:
            print("crew debrief status has not been provided in user inquiry. Trying to get it from sly_data")
            crew_debrief_status = sly_data.get("crew_debrief_status")
            if crew_debrief_status: 
                # sly_data["crew_debrief_status"] = crew_debrief_status
                print("\n")
                print("\n")
                print("####### crew_debrief_status read from sly data: #######", passenger_disembarkation_status)
                print("\n")
                print("\n")
        else: 
            sly_data["crew_debrief_status"] = crew_debrief_status       
            print("\n")
            print("\n")
            print("####### crew debrief status read from args: #######", crew_debrief_status)
            print("\n")
            print("\n")
