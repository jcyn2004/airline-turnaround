...
#         # acu_connection_status_temp = 'pending'
#         # gpu_connection_status_temp = 'pending'
#         jetbridge_connection_status_temp = 'retracted'
#         door_opening_status = 'closed'

#         print("\n")
#         print("\n")
#         print(" #################### API TRACKER FOR AIRCRAFT DOOR OPENING #################### ")
#         print("\n")
#         print("\n")
#         # flight number is needed in particular. 
#         flight_number: str = args.get("flight_number", None)
...
#         # wheels chocks installation status is required to fulfill the request.
#         jetbridge_connection_status: str = args.get("jetbridge_connection_status", None)
#         print("jetbridge_connection_status from args: ", jetbridge_connection_status)
#         print("\n")
#         print("\n")
#         if not jetbridge_connection_status:
#             print("No jetbridge connection status provided. Trying to get it from sly_data")
#             jetbridge_connection_status = sly_data.get("jetbridge_connection_status")
#             # sly_data["gate_id"] = gate_id
#             print("jetbridge_connection_status from sly data: ", jetbridge_connection_status)
#             print("\n")
#             print("\n")
#         # if not jetbridge_connection_status:
#             # error = "Error: Please provide gpu connection status for the request."
#             # print(error)
#             # return error  
#             jetbridge_connection_status = jetbridge_connection_status_temp
...
#         if (('done' in jetbridge_connection_status) | ('connected' in jetbridge_connection_status)): 
#             door_opening_status = 'opened'

#             message = f"door opening status is {door_opening_status}."
#             # message = f"Flight {flight_number} with airplane type {aircraft_type} {flight_status} at gate {gate_id} has door opened installed. Its door opening status is {door_opening_status}."
#             print(message)
#             print("\n")
#             print("\n")
#             print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
