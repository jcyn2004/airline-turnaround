...
class gpu_operator(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        if not engines_stop_status:
            error = "Error: Please provide engines stop status for the request."
            print(error)
            return error  
        ...
        print("\n")
        print("\n")
        print("wheels_chocks_installation_status: ", wheels_chocks_installation_status)
        print("\n")
        print("\n")
        ...
        if ((('done' in engines_stop_status) | ('stopped' in engines_stop_status)) & (('done' in wheels_chocks_installation_status) | ('installed' in wheels_chocks_installation_status))): 
            ...
            message = f"Flight {flight_number} with airplane type {aircraft_type} {flight_status} at gate {gate_id} has gpu installed. Its gpu installation status is {gpu_connection_status}."
            print(message)
            print("\n")
            print("\n")
            print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
...
class trackerAPI(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### API TRACKER GENERIC - AIRCRAFT ACU CONNECT #################### ")
        print("\n")
        print("\n")
        ...
        #####################################################################################################################################
        return flight_status,engines_stop_status,wheels_chocks_installation_status
