...
class crew_exit_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### CREW EXIT OPERATOR #################### ")
        print("\n")
        print("\n") 

        print("\n")
        print("\n")
        print(" #################### CREW EXIT OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### CREW EXIT OPERATOR - JERTBRIDGE CONNECT STATUS UPDATE - DOOR OPENING STATUS #################### ")
        print("\n")
        print("\n")
...
class trackerAPI(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        if not crew_exit_status:
            print("crew exit status has not been provided in user inquiry. Trying to get it from sly_data")
            crew_exit_status = sly_data.get("crew_exit_status")
            if crew_exit_status: 
                print("\n")
                print("\n")
                print("####### crew exit status read from sly data: #######", crew_exit_status)
                print("\n")
                print("\n")
        else: 
            sly_data["crew_exit_status"] = crew_exit_status       
            print("\n")
            print("\n")
            print("####### crew exit status read from args: #######", crew_exit_status)
            print("\n")
            print("\n")
