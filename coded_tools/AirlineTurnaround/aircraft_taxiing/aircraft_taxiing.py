...
class execute_aircraft_taxiing(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[str, Dict[str, Any]]:
        ...
        # Read inputs (args first, then sly_data)
        # flight_status         = _from_args_or_sly(sly_data, args, "flight_status")
        # aircraft_type         = _from_args_or_sly(sly_data, args, "aircraft_type")
        # flight_number         = _from_args_or_sly(sly_data, args, "flight_number")
        # gate_id               = _from_args_or_sly(sly_data, args, "gate_id")
        # ground_clearance_type = _from_args_or_sly(sly_data, args, "ground_clearance_type")
        # ground_clearance_status = _from_args_or_sly(sly_data, args, "ground_clearance_status")
        # assigned_runway_id    = _from_args_or_sly(sly_data, args, "assigned_runway_id")
        # gpu_readiness_status      = _from_args_or_sly(sly_data, args, "gpu_readiness_status")
        # wheels_chocks_readiness_status = _from_args_or_sly(sly_data, args, "wheels_chocks_readiness_status")
...
#         assigned_runway: str = args.get("assigned_runway", None)   
#         gate_id: str = args.get("gate_id", None)   
#         # flight_tracker_inquiry_mode: str = args.get("flight_tracker_inquiry_mode", None)   
...
#         sly_data["assigned_runway"] = assigned_runway   
#         sly_data["gate_id"] = gate_id   
#         # sly_data["flight_tracker_inquiry_mode"] = flight_tracker_inquiry_mode     
#         sly_data["gpu_readiness_status"] = gpu_readiness_status   
#         sly_data["chocks_readiness_status"] = chocks_readiness_status   

#         # if ('read' in flight_tracker_inquiry_mode): 
#         #     # Write parameters to sly_data
#         #     sly_data["flight_number"] = flight_number   
#         #     sly_data["aircraft_type"] = aircraft_type   
#         #     sly_data["ground_clearance_type"] = ground_clearance_type   
