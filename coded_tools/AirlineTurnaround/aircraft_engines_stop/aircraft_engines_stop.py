...
class engines_stop_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### ENGINES STOP OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        if (('on' in flight_status) & ('blocks' in flight_status)): 
            ...
            print("\n")
            print("\n")
            print(" #################### ENGINES STOP OPERATOR - FLIGHT STATUS UPDATE - ENGINES STOPPED #################### ")
            print("\n")
            print("\n")
            ...
            print("\n")
            print("\n")
            print('engines_stop_status is: ', engines_stop_status)
            print("\n")
            print("\n")
            print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
...
class trackerAPI(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### API TRACKER GENERIC - AIRCRAFT ENGINES STOP #################### ")
        print("\n")
        print("\n")
