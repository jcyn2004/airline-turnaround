...
class execute_air_conditioning_unit_operator(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[str, Dict[str, Any]]:
        ...
        print("\n")
        print("\n")
        print("LOG FILE PATH:", file_path_log)
        print("GROUND EQUIPMENTS BASE PATH:", ground_equipments_base)
        print("\n")
        print("\n")
        ...
        print("---------------------------------------------")
        print(df)
        print("ACO READINESS INQUIRY")
        print("gate_item_count: ", gate_item_count)
        print(df1)
        if df1.shape[0] > 0:
            acu_readiness_status = df.loc[df['gate_id'] == gate_id, 'air_conditioning_unit_readiness'].iloc[0]
...
class execute_ground_power_unit_operator(CodedTool):
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[str, Dict[str, Any]]:
        ...
        print("---------------------------------------------")
        print(df)
        print("GPU READINESS INQUIRY")
        print("gate_item_count: ", gate_item_count)
        print(df1)
        if df1.shape[0] > 0:
            gpu_readiness_status = df.loc[df['gate_id'] == gate_id, 'ground_power_unit_readiness'].iloc[0]
...
class execute_wheels_chocks_operator(CodedTool):
    ...
    def __init__(self):
        ...
        print("\n")
        print("\n")
        print("STARTING WHEELS CHOCKS OPERATOR")
        print("\n")
        print("\n")
        print("################################################################")
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[str, Dict[str, Any]]:
        ...
        wheels_chocks_readiness_status = 'off'
        ...
        print("---------------------------------------------")
        print(df)
        print("WHEELS CHOCKSREADINESS INQUIRY")
        print("gate_item_count: ", gate_item_count)
        print(df1)
        if df1.shape[0] > 0:
