...
class execute_ground_clearance(CodedTool):
    ...
    def __init__(
        self,
        aircraft_base: str = "/Users/971244/workspace/neuro-san-studio/coded_tools/aircraft_traffic_controller/aircraft_base.csv",
        runway_base: str = "/Users/971244/workspace/neuro-san-studio/coded_tools/aircraft_traffic_controller/runways_base.csv",
