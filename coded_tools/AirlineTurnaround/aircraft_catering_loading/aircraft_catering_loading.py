...
class catering_loading_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### CATERING LOADING OPERATOR #################### ")
        print("\n")
        print("\n")

        print("\n")
        print("\n")
        print(" #################### CATERING LOADING OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### CATERING LOADING OPERATOR - PASSENGER DISEMBARKATION STATUS - CREW EXIT STATUS - BAGGAGE UNLOAD STATUS #################### ")
        print("\n")
        print("\n")
        ...
        if (((passenger_disembarkation_status == 'completed') | (passenger_disembarkation_status == 'done')) & ((crew_exit_status == 'completed') | (crew_exit_status == 'exited')) & ((baggage_unload_status == 'completed') | (baggage_unload_status == 'unloaded'))):
            ...
            message = f"Flight {flight_number} with airplane type {aircraft_type} {flight_status} at gate {gate_id} has catering loading {catering_loading_status}. Its catering loading status is {catering_loading_status}."
            print(message)
            print("\n")
            print("\n")
            print(">>>>>>>>>>>>>>>>>>> DONE !!! >>>>>>>>>>>>>>>>>>")
            ...
            sly_data["catering_loading_status"] = catering_loading_status

        return catering_loading_status
