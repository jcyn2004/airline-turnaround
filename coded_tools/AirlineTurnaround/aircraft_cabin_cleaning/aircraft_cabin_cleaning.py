...
class cabin_cleaning_operator(CodedTool):
    """
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> Union[Dict[str, Any], str]:
        ...
        print("\n")
        print("\n")
        print(" #################### CABIN CLEANING OPERATOR #################### ")
        print("\n")
        print("\n")

        print("\n")
        print("\n")
        print(" #################### CABIN CLEANING OPERATOR - PARAMETERS #################### ")
        print("\n")
        print("\n")
        ...
        print("\n")
        print("\n")
        print(" #################### CABIN CLEANING OPERATOR - PASSENGER DISEMBARKATION STATUS - CREW EXIT STATUS - BAGGAGE UNLOAD STATUS #################### ")
        print("\n")
        print("\n")
        ...
        if (((passenger_disembarkation_status == 'completed') | (passenger_disembarkation_status == 'done')) & ((crew_exit_status == 'completed') | (crew_exit_status == 'exited')) & ((baggage_unload_status == 'completed') | (baggage_unload_status == 'unloaded'))):
            ...
            sly_data["cabin_cleaning_status"] = cabin_cleaning_status

        return cabin_cleaning_status
